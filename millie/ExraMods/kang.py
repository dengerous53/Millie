...
api_id = API_ID #int of api id get from my.telegram.org
api_hash = API_HASH # " Your Api Hash Here " #str of api hash get from my.telegram.org
token = BOT_TOKEN # ' Your Bot Token here ' #str of token get from BotFather
